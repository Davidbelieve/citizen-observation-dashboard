...
class ObservationServiceTest {
    ...
    void testCreateObservation_ValidRequest_ReturnsResponse() {
        ...
        // Act
        ObservationResponse response = observationService.createObservation(validRequest);
    ...
    void testGetByCitizenId_ReturnsMatchingObservations() {
        // Arrange
        List<Observation> observations = Arrays.asList(savedObservation);
        when(observationRepository.findByCitizenId("C200")).thenReturn(observations);
        ...
        verify(observationRepository, times(1)).findByCitizenId("C200");
    }
