...
public class RewardsController {
     ...
     * 
     * @return List of RewardResponse for top contributors
     */
    @GetMapping("/leaderboard")
    public ResponseEntity<java.util.List<RewardResponse>> getLeaderboard() {
        logger.info("Received request for leaderboard");
        java.util.List<RewardResponse> leaderboard = rewardsService.getLeaderboard();
