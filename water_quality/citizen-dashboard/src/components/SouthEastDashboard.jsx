...
import './SouthEastDashboard.css';

const SouthEastDashboard = () => {
    ...
    const fetchDashboardData = async () => {
        ...
        // Changing to use localhost:8080/api/observations via gateway
        try {
    ...
    return (
        <div className="se-dashboard">
            <header className="se-header">
                <h1>South East Water Quality Dashboard</h1>
                <p>Local Authority Overview</p>
            </header>

            <div className="se-grid">
                {/* Total Stats Card */}
                <div className="se-card total-card">
                    <h3>Total Observations</h3>
                    <div className="big-number">{stats.totalObservations}</div>
                    <p>Submitted in South East Region</p>
                </div>

                {/* Leaderboard Card */}
                <div className="se-card leaderboard-card">
                ...
                <div className="se-card recent-card">
...
export default SouthEastDashboard;
